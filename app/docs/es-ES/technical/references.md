...
Fuentes oficiales citadas por la auditoria y usadas como referencia tecnica. Fecha de consulta: 2026-09-17. Cada operador debe contrastar las versiones exactas de su plataforma antes de desplegar.

| Tema | Referencia oficial |
|---|---|
| Laravel 12 despliegue | <https://laravel.com/docs/12.x/deployment> |
| Laravel 12 base de datos | <https://laravel.com/docs/12.x/database> |
| Laravel 12 colas | <https://laravel.com/docs/12.x/queues> |
| Laravel 12 sesiones | <https://laravel.com/docs/12.x/session> |
...
| PostgreSQL 18 backup y restore | <https://www.postgresql.org/docs/18/backup.html> |
...
| Caddy request body | <https://caddyserver.com/docs/caddyfile/directives/request_body> |
...
Estas referencias no sustituyen la verificacion local. Si la version instalada difiere, validar cambios de configuracion, seguridad, CLI y compatibilidad antes de operar.
