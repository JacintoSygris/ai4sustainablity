...
- **API**: interface for other systems to communicate with the application.
- **CSV**: text table file, useful for spreadsheets.
...
- **Pending**: information or a previous action is missing.
- **In progress**: partial information has been saved.
- **Complete**: the field or block meets the application's format rules.
- **Ready**: the download can be attempted with the current state.
- **Blocked**: a technical or journey condition is missing.
- **Scoping mode**: decisions are retained, but not all topical items are included until a configured and valid mapping exists.

These statuses describe what the application knows or checks. They do not certify material accuracy, methodological sufficiency or external acceptance.
