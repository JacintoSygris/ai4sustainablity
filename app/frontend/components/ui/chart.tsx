    ...
    >
      ...
      <div className="grid gap-1.5">
        {payload.map((item, index) => {
          ...
          const itemConfig = getPayloadConfigFromPayload(config, item, key)
          const indicatorColor = color || payloadField(item.payload, 'fill') || item.color
...
function payloadField(payload: Record<string, unknown> | undefined, key: string): string | undefined {
