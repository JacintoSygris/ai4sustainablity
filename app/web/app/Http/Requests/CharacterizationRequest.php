...
class CharacterizationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        $rules['form_data.activity_questions'] = ['sometimes', 'array'];
        foreach (array_keys(CharacterizationOptions::activityQuestions()) as $questionKey) {
            $rules["form_data.activity_questions.{$questionKey}"] = ['sometimes', 'nullable', 'string', Rule::in($yesNoUnknownKeys)];
        }
