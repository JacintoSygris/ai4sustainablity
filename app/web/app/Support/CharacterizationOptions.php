...
class CharacterizationOptions
{
    ...
    {
        return [
            'physical_operations' => '¿La empresa posee u opera instalaciones físicas propias (fábricas, plantas, talleres, almacenes, terrenos agrícolas), en lugar de ser únicamente una oficina, holding o entidad financiera?',
            'water_use' => '¿Alguna actividad propia usa o vierte agua de forma relevante (refrigeración, limpieza industrial, procesado de alimentos, riego, teñido…)?',
            'hazardous_substances' => '¿Se usan, almacenan, transportan o generan sustancias peligrosas, combustibles, emisiones o residuos que requieran algún control ambiental?',
            'biodiversity_sensitive_locations' => '¿Hay instalaciones, obras o terrenos en o cerca de espacios naturales protegidos, bosques, humedales, masas de agua o zonas de biodiversidad sensible?',
            'physical_goods_resources' => '¿La actividad fabrica, envasa o procesa bienes físicos, o consume materias primas o genera residuos de forma significativa?',
            'external_value_chain_workers' => '¿Dependen las operaciones de proveedores, subcontratas, fabricación externalizada o trabajo logístico donde las personas no están en la plantilla propia?',
            'local_communities' => '¿Pueden las operaciones afectar de forma directa a comunidades locales (ruido, tráfico, obras, uso de suelo, dependencia de empleo local, permisos)?',
            'consumer_end_users' => '¿Venden productos o servicios usados directamente por consumidores o usuarios finales cuya seguridad, salud, privacidad o bienestar pueda verse afectada?',
            'international_footprint' => '¿Hay actividad, proveedores o clientes relevantes fuera de España o cadenas de suministro internacionales?',
        ];
    }

    public static function activityQuestionsNote(): string
    {
        return 'Estas preguntas son opcionales y ayudan a afinar la propuesta inicial de temas. Si no lo tienes claro, deja "No estoy seguro".';
    }
