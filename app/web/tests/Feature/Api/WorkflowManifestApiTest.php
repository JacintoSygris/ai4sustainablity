...
it('returns frontend workflow phases and backend capabilities', function () {
    $this->actingAs(User::factory()->create())
        ...
        ->assertJsonPath('data.frontend_source.integration_notes.0', 'The active P5-P10 workflow is Laravel-owned.')
        ->assertJsonPath('data.frontend_source.integration_notes.1', 'Local Next backend routes are not authoritative IA4S workflow APIs.')
        ...
        ->assertJsonPath('data.capabilities.p9.granularity', 'standard_level_partial')
